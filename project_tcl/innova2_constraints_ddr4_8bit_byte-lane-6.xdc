...
# Byte Lane 6 - Bank 67 - For 8bit DDR4 Test, Use as Byte Lane 0
set_property PACKAGE_PIN AV30 [get_ports {ddr4_rtl_0_dqs_t[0]}]
set_property PACKAGE_PIN AW30 [get_ports {ddr4_rtl_0_dqs_c[0]}]
set_property PACKAGE_PIN AU28 [get_ports {ddr4_rtl_0_dm_n[0]}]

set_property PACKAGE_PIN AW29 [get_ports {ddr4_rtl_0_dq[0]}]
set_property PACKAGE_PIN AW31 [get_ports {ddr4_rtl_0_dq[1]}]
set_property PACKAGE_PIN AV31 [get_ports {ddr4_rtl_0_dq[2]}]
set_property PACKAGE_PIN AU29 [get_ports {ddr4_rtl_0_dq[3]}]
set_property PACKAGE_PIN AU30 [get_ports {ddr4_rtl_0_dq[4]}]
set_property PACKAGE_PIN AT29 [get_ports {ddr4_rtl_0_dq[5]}]
set_property PACKAGE_PIN AW28 [get_ports {ddr4_rtl_0_dq[6]}]
set_property PACKAGE_PIN AT30 [get_ports {ddr4_rtl_0_dq[7]}]
